...
from config import DATA_DIR, OUTPUT_DIR, DOCKERFILE_DIR
...
class PathUtil:
    ...
    @staticmethod
    def get_docker_file_filepath(reponame, filename="Dockerfile"):
        return Path(DOCKERFILE_DIR, reponame, f"{filename}")
