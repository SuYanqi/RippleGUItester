...
class ProductComponentPair(_Data):
    ...
    def __lt__(self, other):
        return f"{self.product}::{self.component}" < f"{other.product}::{other.component}"
...
class ProductComponentPairFramework(_Data):
...
class ProductComponentPairs(_Data):
