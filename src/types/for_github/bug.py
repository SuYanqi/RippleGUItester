...
from src.types.description import Description
from src.types.product_component_pair import ProductComponentPairFramework
from src.types.tossing_path import TossingPathFramework
...
class Bug:
    ...
    def get_comments(comments_dict):
        ...
        for comment_dict in comments_dict:
            comments.append(Comment.from_commit_file_dict(comment_dict))
        return comments
