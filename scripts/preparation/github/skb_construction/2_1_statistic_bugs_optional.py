...
from config import DATA_DIR, APP_NAME_FIREFOX, APP_NAME_THUNDERBIRD, APP_NAME_VSCODE, APP_NAME_ZETTLR, APP_NAME_GODOT, \
    APP_NAME_JABREF
...
if __name__ == "__main__":
    ...
    # issues_pulls_filename = "issues_pulls"
    bug_objects = "bugs"
    # start_index = 0
    # # end_index = 72621
    # end_index = 490644
    ...
    if len(fixed_bugs_with_commits) != 0:
