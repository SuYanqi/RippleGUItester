...
from config import APP_NAME_FIREFOX, DATA_DIR, APP_NAME_VSCODE, APP_NAME_ZETTLR, APP_NAME_GODOT, APP_NAME_JABREF

if __name__ == "__main__":
    # Parse command line arguments
    parser = argparse.ArgumentParser(description="Create vector stores for a specific repository")
    parser.add_argument(
        "--repo",
        type=str,
