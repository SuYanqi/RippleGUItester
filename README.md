...
```bash
wget https://github.com/SuYanqi/RippleGUItester/releases/download/v1.0/data.zip
unzip data.zip
```
...
```bash
wget https://github.com/SuYanqi/RippleGUItester/releases/download/v1.0/output.zip
unzip output.zip
```
